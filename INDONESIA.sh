...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  MR.K7C8NG  "$i"                    "
echo $i""$pu"  WhatsApp:  085347683869"$i"                "
echo $i""$pu"  TAEM   :  InDoNeSiA CYBER ErRoR SyStEm"$i"     "
echo $i""$pu"  instagram :  pranata_pasha"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"instagram :"$i" pranata_pasha"
echo $ku"TEAM  :"$i" InDoNeSiA CYBER ErRoR SyStEm"
